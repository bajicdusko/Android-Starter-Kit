package com.bajicdusko.androidstarterkit.core;
...
import com.bajicdusko.androidstarterkit.core.rest.ApiFactory;
import com.bajicdusko.androidstarterkit.core.rest.ApiModule;
        ...
        Configuration configuration = new Configuration.Builder(context)
                ...
                .injector(new DependencyInjector() {
                    ...
                    public void inject(BaseJob job) {
                        AndroidStarterKitDaggerComponent component = ((AndroidStarterKitApplication) context.getApplicationContext()).injector();
